...
void UIEngine::UIEngine::setup() {
    this->add_theme("light", UITheme{ .colors = {
			...
			{ "card_foreground", { 26, 24, 25, 255 } }, 
			{ "popover", { 242, 241, 242, 255 } }, 
			{ "popover_foreground", { 4, 0, 1, 255 } }, 
			{ "primary", { 67, 49, 53, 255 } }, 
			{ "primary_foreground", { 255, 255, 255, 255 } }, 
			{ "secondary", { 186, 170, 174, 255 } }, 
			{ "secondary_foreground", { 0, 0, 0, 0 } }, 
			{ "muted", { 220, 212, 219, 255 } }, 
			{ "muted_foreground", { 91, 87, 88, 255 } }, 
			{ "accent", { 209, 198, 207, 255 } }, 
			{ "accent_foreground", { 26, 24, 25, 255 } }, 
			{ "destructive", { 114, 38, 38, 255 } }, 
			{ "destructive_foreground", { 230, 228, 229, 255 } }, 
    ...
    this->add_theme("dark", UITheme{ .colors = {
			...
			{"card", {2, 2, 2, 255}},
			{"card_foreground", {230, 228, 229, 255}},
			{"popover", {14, 11, 12, 255}},
			{"popover_foreground", {230, 228, 229, 255}},
			{"primary", {67, 49, 53, 255}},
			{"primary_foreground", {255, 255, 255, 255}},
			{"secondary", {28, 22, 24, 255}},
			{"secondary_foreground", {255, 255, 255, 255}},
			{"muted", {42, 34, 40, 255}},
			{"muted_foreground", {155, 150, 151, 255}},
			{"accent", {42, 34, 40, 255}},
			{"accent_foreground", {230, 228, 229, 255}},
			{"destructive", {114, 38, 38, 255}},
			{"destructive_foreground", {230, 228, 229, 255}},
			{"border", {55, 36, 40, 255}},
			{"input", {55, 36, 40, 255}},
